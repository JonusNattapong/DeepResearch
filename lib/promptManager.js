...
const DEFAULT_PROMPTS = {
  agent: `You are the DEEP RESEARCH AI - An advanced autonomous research agent.
...
Your task is to produce an EXHAUSTIVE DEEP RESEARCH DOSSIER on the provided topic.
